        ...
        private void SaveAsJson(string fileName)
        {
            ...
            foreach (DataGridViewRow row in dataGridViewStudentsGrades.Rows)
            {
                if (!row.IsNewRow)
                {
                    var student = new
                    {
                        RegistrationNumber = row.Cells[0].Value?.ToString(),
                        Name = row.Cells[1].Value?.ToString(),
                        LastName = row.Cells[2].Value?.ToString(),
                        Unit1 = row.Cells[3].Value?.ToString(),
                        Unit2 = row.Cells[4].Value?.ToString(),
                        Unit3 = row.Cells[5].Value?.ToString(),
                        Unit4 = row.Cells[6].Value?.ToString(),
                        Unit5 = row.Cells[7].Value?.ToString(),
                        Unit6 = row.Cells[8].Value?.ToString(),
                        Summative = row.Cells[9].Value?.ToString(),
                        Average = row.Cells[10].Value?.ToString()
                    };
            ...
            using (var writer = new StreamWriter(fileName))
            {
                ...
                foreach (DataGridViewRow row in dataGridViewStudentsGrades.Rows)
                {
                    if (!row.IsNewRow)
                    {
                        ...
                        writer.WriteLine($"    <RegistrationNumber>{SecurityElement.Escape(row.Cells[0].Value?.ToString())}</RegistrationNumber>");
                        writer.WriteLine($"    <Name>{SecurityElement.Escape(row.Cells[1].Value?.ToString())}</Name>");
                        writer.WriteLine($"    <LastName>{SecurityElement.Escape(row.Cells[2].Value?.ToString())}</LastName>");
                        writer.WriteLine($"    <Unit1>{SecurityElement.Escape(row.Cells[3].Value?.ToString() ?? "0")}</Unit1>");
                        writer.WriteLine($"    <Unit2>{SecurityElement.Escape(row.Cells[4].Value?.ToString() ?? "0")}</Unit2>");
                        writer.WriteLine($"    <Unit3>{SecurityElement.Escape(row.Cells[5].Value?.ToString() ?? "0")}</Unit3>");
                        writer.WriteLine($"    <Unit4>{SecurityElement.Escape(row.Cells[6].Value?.ToString() ?? "0")}</Unit4>");
                        writer.WriteLine($"    <Unit5>{SecurityElement.Escape(row.Cells[7].Value?.ToString() ?? "0")}</Unit5>");
                        writer.WriteLine($"    <Unit6>{SecurityElement.Escape(row.Cells[8].Value?.ToString() ?? "0")}</Unit6>");
                        writer.WriteLine($"    <Summative>{SecurityElement.Escape(row.Cells[9].Value?.ToString() ?? "0")}</Summative>");
                        writer.WriteLine($"    <Average>{SecurityElement.Escape(row.Cells[10].Value?.ToString() ?? "0")}</Average>");
                        writer.WriteLine("  </Student>");
                    }
                }
