    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("The student list is full.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (dataGridViewStudents.SelectedRows.Count > 0)
            {
                ...
                foreach (DataGridViewRow row in dataGridViewStudents.SelectedRows)
                {
                    ...
                    int index = Array.FindIndex(students, s => s != null && s.RegistrationNumber == registrationNumber);

                    if (index >= 0)
                    {
                        // Eliminar del arreglo de estudiantes (marcar como null)
                        students[index] = null;

                        // Decrementar el contador de estudiantes
                        studentCount--;
                ...
                // Compactar el arreglo para eliminar elementos nulos
                CompactArray();
        ...
        private void CompactArray()
        {
            ...
            // Llenar el resto del arreglo con nulls
